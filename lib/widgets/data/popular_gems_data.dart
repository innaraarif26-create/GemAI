...
final gems = [
  {
    ...
    "model": GemDetailModel(
      ...
      prices: [
        ...
        PriceInfo(
            quality: "Medium Quality", price: "\$2000 – \$5000 per carat"),
        PriceInfo(quality: "Low Quality:", price: "\$500 – \$2000 per carat"),
      ],
      qualityFactors: [
        QualityFactor(
          title: "Color",
          description: "Graded from D (colorless) to Z (light yellow/brown). Less color usually means higher value.",),
        QualityFactor(title: "Clarity",
            description: "Measures the presence of internal or external imperfections (inclusions or blemishes)."),
        QualityFactor(
          title: "Cut",
          description: "Determines the diamond's brilliance and sparkle. Excellent cuts reflect light perfectly.",),
        QualityFactor(title: "Carat",
            description: "Refers to the weight of the diamond. Higher carat usually means larger size and higher price."),
      ],
      ...
      imitations: [
        ImitationItem(
          ...
          desc: "Synthetic, cheaper and less hard than a real diamond.\n",),
        ImitationItem(
          img: AppImages.moissanite,
          title: "Moissanite",
          desc: "Lab-created gemstone resembling diamond in brilliance but slightly softer.\n",),
        ImitationItem(
          img: AppImages.whiteSapphire,
          title: "White Sapphire",
          desc: "Natural gemstone that mimics diamond but lacks sparkle and hardness.\n",),
        ImitationItem(
          img: AppImages.glass,
          title: "Glass or Crystal",
          desc: "Low-cost imitations that are very soft and fragile.",),
      ],
      history: [
  ...
  },
  {
    ...
    "model": GemDetailModel(
      ...
      qualityFactors: [
        QualityFactor(
          title: "Color",
          description: "Deep purple with red or blue flashes is highest quality.",),
        QualityFactor(
          title: "Clarity", description: "Eye-clean stones increase value.",),
        QualityFactor(
          title: "Cut", description: "Well-cut stones reflect light better.",),
        QualityFactor(
          title: "Origin",
          description: "Siberian & African stones have richest colors.",),
      ],
      origins: ["Brazil", "Uruguay", "Zambia", "Russia (Siberia)"],
      imitations: [
        ImitationItem(
          img: AppImages.amethystGlass,
          title: "Glass",
          desc: "Common imitation with low hardness and weaker color.\n",),
        ImitationItem(
          img: AppImages.amethystQuartz,
          title: "Dyed Quartz",
          desc: "Quartz dyed purple to mimic Amethyst.\n",),
        ImitationItem(
          img: AppImages.amethystPaste,
          title: "Glass Paste",
          desc: "Soft glass imitation used in low-cost jewelry.\n",),
        ImitationItem(img: AppImages.amethystSynthetic,
            title: "Synthetic Amethyst",
            desc: "Lab-grown versions that look identical but cost much less."),
      ],
      history: [
  ...
  },
  {
    ...
    "model": GemDetailModel(
      ...
      qualityFactors: [
        QualityFactor(
          title: "Color",
          description: "Deep blue-violet is most valuable; lighter or greenish tones are less valued.",),
        QualityFactor(
          title: "Clarity",
          description: "Eye-clean stones without inclusions are preferred.",),
        QualityFactor(
          title: "Cut",
          description: "Well-cut stones enhance brilliance and pleochroism.",),
        QualityFactor(
          title: "Carat",
          description: "Larger stones with rich color are more valuable.",),
      ],
      origins: [
      ...
      imitations: [
        ImitationItem(
          ...
          title: "Colored Glass",
          desc: "Low-cost imitation lacking hardness and pleochroism.\n",),
        ImitationItem(img: AppImages.cubicZirconia,
            title: "Cubic Zirconia",
            desc: "Synthetic stone resembling Tanzanite but less vibrant."),
      ],
      history: [
  ...
  },
  {
    ...
    "model": GemDetailModel(
      ...
      qualityFactors: [
        QualityFactor(
          title: "Color",
          description: "Deep orange & Madeira tones are most valuable.",),
        QualityFactor(
          title: "Clarity",
          description: "Eye-clean stones are highly valued.",),
        QualityFactor(
          title: "Cut", description: "Well-cut stones show more brilliance.",),
        QualityFactor(
          title: "Treatment",
          description: "Most citrine is heat-treated amethyst.",),
      ],
      origins: ["Brazil", "Madagascar", "Russia", "Zambia & Namibia"],
      imitations: [ ImitationItem(
        img: AppImages.heatAmethyst,
        title: "Heat-treated Amethyst",
        desc: "Most common imitation.\n",), ImitationItem(
        img: AppImages.glassYellow,
        title: "Yellow Glass",
        desc: "Very inexpensive imitation.\n",), ImitationItem(
        img: AppImages.yellowTopaz,
        title: "Yellow Topaz",
        desc: "Often mistaken due to similar color.\n",),
      ],
      history: [
  ...
  },
  {
    ...
    "model": GemDetailModel(
      ...
      prices: [
        PriceInfo(
          quality: "High Quality", price: "\$1,000 – \$8,000 per carat",),
        PriceInfo(
          quality: "Medium Quality", price: "\$200 – \$1,000 per carat",),
        PriceInfo(
          quality: "Low Quality", price: "\$50 – \$200 per carat",),
      ],
      qualityFactors: [
        QualityFactor(
          title: "Color", description: "Rich vivid green is most valuable.",),
        QualityFactor(
          title: "Clarity",
          description: "Slight inclusions acceptable; eye-clean stones are rare.",),
        QualityFactor(
          title: "Cut",
          description: "Well-cut stones enhance brightness and maximize color.",),
        QualityFactor(
          title: "Treatment",
          description: "Most emeralds are oiled to enhance clarity; untreated stones are more valuable.",),
      ],
      origins: [ "Colombia", "Zambia", "Brazil", "Afghanistan", "Pakistan",],
      imitations: [
        ImitationItem(
          img: AppImages.glassGreen,
          title: "Green Glass",
          desc: "Cheap imitation with weaker brilliance and depth.\n",),
        ImitationItem(
          img: AppImages.beryl,
          title: "Beryl",
          desc: "Natural stone resembling emerald but softer green.\n",),
        ImitationItem(
          img: AppImages.fluorite,
          title: "Fluorite",
          desc: "Low-cost imitation lacking durability and easily scratched.",),
      ],
      history: [
  ...
  },
  {
    ...
    "model": GemDetailModel(
      ...
      prices: [
        PriceInfo(
          quality: "High Quality", price: "\$8,000 – \$15,000 per carat",),
        PriceInfo(
          quality: "Medium Quality", price: "\$300 – \$8,000 per carat",),
        PriceInfo(
          quality: "Low Quality", price: "\$50 – \$300 per carat",),
      ],
      qualityFactors: [
        QualityFactor(
          title: "Color",
          description: "Bright vivid red (pigeon blood red) is most valuable.",),
        QualityFactor(
          title: "Clarity",
          description: "Minor inclusions are normal; eye-clean stones are rare.",),
        QualityFactor(
          title: "Cut",
          description: "Well-cut rubies maximize brilliance and color.",),
        QualityFactor(
          title: "Treatment",
          description: "Most rubies are heat-treated; untreated stones are more valuable.",),
      ],
      origins: [
        "Myanmar (Burma)",
        "Thailand",
      ...
      imitations: [
        ImitationItem(
          ...
          title: "Red Glass",
          desc: "Low-cost imitation lacking the brilliance of natural ruby.\n",),
        ImitationItem(
          img: AppImages.zirconRed,
          title: "Red Zircon",
          desc: "Natural gemstone resembling ruby but softer in color.\n",),
        ImitationItem(
          img: AppImages.spinel,
          title: "Spinel",
          desc: "Often mistaken for ruby; slightly softer but naturally beautiful.",),
      ],
      history: [
  ...
  },
  {
    ...
    "model": GemDetailModel(
      ...
      prices: [ PriceInfo(
        quality: "High Quality", price: "\$200 – \$600 per carat",), PriceInfo(
        quality: "Medium Quality", price: "\$50 – \$200 per carat",), PriceInfo(
        quality: "Low Quality", price: "\$20 – \$50 per carat",),
      ],
      qualityFactors: [
        QualityFactor(
          title: "Color",
          description: "Intense sea-blue shades are most valuable.",),
        QualityFactor(
          title: "Clarity",
          description: "Transparent stones with minimal inclusions are preferred.",),
        QualityFactor(
          title: "Cut",
          description: "Faceted cuts enhance sparkle and brilliance.",),
        QualityFactor(
          title: "Treatment",
          description: "Often heat-treated to remove greenish tones.",),
      ],
      ...
      imitations: [
        ImitationItem(
          img: AppImages.blueGlass,
          title: "Blue Glass",
          desc: "Soft and inexpensive imitation commonly used in jewelry.\n",),
        ImitationItem(
          img: AppImages.berylGreen,
          title: "Green Beryl",
          desc: "Lower-quality beryl sometimes dyed to resemble aquamarine.",),
      ],
      history: [
  ...
  },
  {
    ...
    "model": GemDetailModel(
      ...
      prices: [
        PriceInfo(
          quality: "High Quality (Royal Blue)",
          price: "\$1,000 – \$4,000 per carat",),
        PriceInfo(
          quality: "Medium Quality", price: "\$150 – \$1,000 per carat",),
        PriceInfo(
          quality: "Low Quality", price: "\$20 – \$150 per carat",),
      ],
      qualityFactors: [
        QualityFactor(
          title: "Color",
          description: "Deep vivid blue with uniform tone is most valuable.",),
        QualityFactor(
          title: "Clarity",
          description: "Eye-clean stones are preferred; minor inclusions are normal.",),
        QualityFactor(
          title: "Cut",
          description: "Well-cut sapphires maximize brilliance and color.",),
        QualityFactor(
          title: "Treatment",
          description: "Heat treatment is common; untreated stones are rarer and more valuable.",),
      ],
      origins: [
        "Kashmir (India)",
        "Myanmar (Burma)",
      ...
      imitations: [
        ImitationItem(
          img: AppImages.blueGlass1,
          title: "Blue Glass",
          desc: "Low-cost imitation with weaker brilliance.\n",),
        ImitationItem(
          img: AppImages.blueZircon,
          title: "Blue Zircon",
          desc: "Natural stone resembling sapphire but slightly softer.\n",),
        ImitationItem(
          img: AppImages.blueSpinel,
          title: "Blue Spinel",
          desc: "Natural gemstone often confused with sapphire but less vivid.",),
      ],
      history: [
  ...
  },
  {
    ...
    "model": GemDetailModel(
      ...
      prices: [ PriceInfo(
        quality: "Hgh Quality (Vivid Pink, Eye-clean)",
        price: "\$300 – \$600 per carat",), PriceInfo(
        quality: "Medium Good Quality (Pink, Slight Inclusions)",
        price: "\$50 – \$300 per carat",), PriceInfo(
        quality: "Low Quality (Pale Pink, Heavily Included)",
        price: "\$10 – \$50 per carat",),
      ],
      qualityFactors: [
        QualityFactor(
          title: "Color",
          description: "Rich pink or peach hues are most desirable.",),
        QualityFactor(
          title: "Clarity",
          description: "Eye-clean stones are preferred; inclusions lower value.",),
        QualityFactor(
          title: "Cut",
          description: "Well-cut stones enhance brilliance and depth of color.",),
      ],
      origins: [
        "Brazil",
        "Mozambique",
      ...
      imitations: [
        ImitationItem(
          img: AppImages.pinkGlass,
          title: "Pink Glass",
          desc: "Low-cost imitation, lacks brilliance and hardness.\n",),
        ImitationItem(
          img: AppImages.pinkTopaz,
          title: "Pink Topaz",
          desc: "Natural stone resembling Morganite, slightly harder but different hue.\n",),
        ImitationItem(
          img: AppImages.pinkQuartz,
          title: "Rose Quartz",
          desc: "Soft, pale pink crystal mimicking Morganite but lacks depth and clarity.",),
      ],
      history: [
  ...
  },
  {
    ...
    "model": GemDetailModel(
      ...
      prices: [ PriceInfo(
        quality: "Imperial Topaz (Rich Orange/Red)",
        price: "\$500 – \$1,500 per carat",), PriceInfo(
        quality: "Pink Topaz", price: "\$300 – \$700 per carat",), PriceInfo(
        quality: "Blue Topaz (Swiss or London Blue)",
        price: "\$20 – \$100 per carat",), PriceInfo(
        quality: "Other Colors / Low Quality", price: "\$5 – \$20 per carat",),
      ],
      qualityFactors: [
        QualityFactor(
          title: "Color",
          description: "Rich, vivid colors like imperial orange or pink are most valuable.",),
        QualityFactor(
          title: "Clarity",
          description: "Eye-clean stones without inclusions are preferred.",),
        QualityFactor(
          title: "Cut",
          description: "Well-cut stones enhance brilliance and sparkle.",),
        QualityFactor(
          title: "Size / Carat",
          description: "Larger stones of good color and clarity are highly valued.",),
      ],
      origins: [ "Brazil", "Russia", "Pakistan", "USA (Utah & Texas)",],
      imitations: [
        ImitationItem(
  ...
  },
  {
    ...
    "model": GemDetailModel(
      ...
      prices: [
        PriceInfo(quality: "Deep Green (High Quality)",
            price: "\$40 – \$120 per carat"),
        PriceInfo(quality: "Medium Green", price: "\$15 – \$40 per carat"),
        PriceInfo(
            quality: "Light / Yellowish Green", price: "\$5 – \$15 per carat"),
      ],
      qualityFactors: [
        QualityFactor(title: "Color",
            description: "Pure lime-green stones are the most valuable."),
        QualityFactor(title: "Clarity",
            description: "Look for eye-clean Peridot with minimal black spots."),
        QualityFactor(title: "Cut",
            description: "Good cutting increases brilliance and hides inclusions."),
        QualityFactor(title: "Size",
            description: "Large Peridot above 5 carats are rarer and pricier."),
      ],
      origins: [ "Pakistan (Kohistan)", "Myanmar", "China", "USA (Arizona)",],
      imitations: [
        ImitationItem(
          img: AppImages.peridotGlass,
          title: "Green Glass",
          desc: "Most common imitation; softer, less brilliance, and very inexpensive.\n",),
        ImitationItem(
          img: AppImages.peridotQuartz,
          title: "Dyed Quartz",
          desc: "Lower-quality quartz is dyed to mimic Peridot’s green color.\n",),
        ImitationItem(
          img: AppImages.peridotSynthetic,
          title: "Synthetic Olivine",
          desc: "Lab-grown material resembling Peridot but cheaper.",),
      ],
      history: [
